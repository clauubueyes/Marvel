...
export function canRevealSpoiler(
  requirement: SpoilerRequirement | undefined,
 ...
 */
export function spoilerProgressHint(
  requirement: SpoilerRequirement | undefined,
  progress: SpoilerProgress,
): { watched: number; required: number } | null {
...
export function protectContent<T>(
  content: T,
  requirement: SpoilerRequirement | undefined,
  progress: SpoilerProgress,
  locked: T,
