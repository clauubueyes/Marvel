...
export function LegalFooter() {
  return <footer className="legal-footer">
    ...
    <nav aria-label="Información legal"><Link href="/privacidad">PRIVACIDAD</Link><Link href="/terminos">CONDICIONES DE USO</Link><a href="mailto:clauubyy@gmail.com">CONTACTO</a></nav>
