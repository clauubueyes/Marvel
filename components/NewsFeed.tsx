  ...
  return (
    <>
      ...
      <div className="story-grid">
        {items.slice(0, 3).map((story, index) => <article className={`story ${artClasses[index]}`} key={story.id}>
          <div className="story-art"><span>{symbols[index]}</span><b>0{index + 1}</b></div>
