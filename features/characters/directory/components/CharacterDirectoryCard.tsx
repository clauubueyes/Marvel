...
export function CharacterDirectoryCard({
  character,
  index,
}: {
  character: Character;
  ...
  return (
    <div
      className="character-directory-card"
      data-reveal
      data-tilt
      style={
        {
    ...
    >
      ...
      />
      <i className="character-card-light" aria-hidden="true" />
      <span>
      ...
      <Link
        ...
        aria-label={`Abrir expediente de ${character.name}`}
      />
