...
export function CharacterPowers({ character }: { character: Character }) {
  ...
  if (!canRevealSpoiler(character.spoilers?.powers ?? UNREVIEWED_SPOILER, progress)) return null;
  return (
    <section className="profile-power profile-section" data-scroll-section data-section-index="03">
      <div className="power-heading" data-reveal>
        <p className="section-label">03 / CAPACIDADES</p>
        <h2>
          MEDIR LO
          <br />
          <em>IMPOSIBLE</em>
        </h2>
        <span>LECTURA DE ENERGÍA / NEXUS</span>
      </div>
