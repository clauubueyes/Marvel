  ...
  return (
    <section className="profile-intro profile-section" data-scroll-section data-section-index="01">
      <div className="identity-title" data-reveal>
        <p className="section-label">01 / IDENTIDAD</p>
        <h2>
          DETRÁS
          <br />
          DEL <em>SÍMBOLO</em>
        ...
        <div className="identity-status">
          <i /> EXPEDIENTE ACTIVO <b>NXS-{character.number}616</b>
        </div>
      </div>
      <div className="identity-portrait" data-reveal data-tilt aria-hidden="true">
        ...
        <Image
          ...
          alt=""
          fill
          sizes="(max-width: 560px) 86vw, 520px"
          style={{ objectPosition: character.imagePosition ?? "center top" }}
        />
      ...
      <div className="intro-copy" data-reveal>
        <p>
          <SpoilerText
            ...
            requirement={character.spoilers?.overview ?? UNREVIEWED_SPOILER}
          />
        </p>
        <dl>
          <div>
          ...
          <div>
            ...
            <dd>
              <SpoilerText
                ...
                requirement={character.spoilers?.status ?? UNREVIEWED_SPOILER}
              />
            </dd>
          </div>
          <div>
            ...
            <dd>
              <SpoilerText
                text={character.affiliations.join(" · ")}
                requirement={character.spoilers?.affiliations ?? UNREVIEWED_SPOILER}
              />
            </dd>
          </div>
        </dl>
        <a className="image-credit" href={character.sourceUrl} target="_blank" rel="noreferrer">
          IMAGEN Y PERSONAJE © MARVEL · VER FUENTE ↗
        </a>
      </div>
    </section>
  );
