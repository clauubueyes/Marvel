...
const roots = {
  EVENTO: { label: "EVENTOS", href: "/eventos" },
  UNIVERSO: { label: "UNIVERSOS", href: "/universos" },
  EQUIPO: { label: "EQUIPOS", href: "/equipos" },
} as const;
...
export function EntityDossier({ entity }: { entity: MCUEntity }) {
  ...
  const structuredData = {
    ...
    articleSection: entity.kind,
    url: entityUrl,
    mainEntityOfPage: entityUrl,
    inLanguage: siteConfig.language,
    about: entity.connections.map(({ label }) => label),
  };
