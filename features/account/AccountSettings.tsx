    ...
    <div className="account-settings-body">
      <aside className="account-settings-nav" aria-label="Identidad y sesión">
        <div className="account-session-id">
          ...
          <div>
            <span className="account-kicker">SESIÓN INICIADA</span>
            <p>{user?.email}</p>
          </div>
        </div>
        <nav className="account-section-links" aria-label="Secciones de la cuenta">
          <a href="#sincronizacion">
            Cuenta y sesión <span aria-hidden="true">↗</span>
          </a>
          <a href="#spoilers">
            Progreso y spoilers <span aria-hidden="true">↗</span>
          </a>
        </nav>
        <div className="account-session-actions">
          <button
            ...
            disabled={logoutBusy || logoutDisabled}
            onClick={onLogout}
          >
            {logoutBusy
              ? "CERRANDO SESIÓN…"
      ...
      <div className="account-settings-content">
        ...
        >
          <header className="account-panel-heading">
            ...
            <p>
              Tu progreso se guarda en tu cuenta. Recárgalo si has marcado títulos desde otro
              dispositivo.
            </p>
          </header>
