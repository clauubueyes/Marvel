...
export function SpoilerProgressSettings() {
  ...
  return (
    <section id="spoilers" className="account-spoilers" aria-labelledby="spoilers-heading">
      ...
      <div className="account-spoiler-summary">
        <div className="account-spoiler-summary-count">
          ...
          <p>
            {error
              ? "Recarga el progreso para comprobar tus títulos."
              : pending
                ? "Guardando tus últimos cambios…"
                : ready
                  ? watched.size
                    ? "Sigue ampliando tu recorrido."
                    : "Marca tu primer título para empezar."
                  : "Recuperando tu progreso…"}
          </p>
        </div>
        <Link className="account-button account-button-primary" href="/titulos">
          GESTIONAR TÍTULOS <span aria-hidden="true">↗</span>
        </Link>
      </div>
