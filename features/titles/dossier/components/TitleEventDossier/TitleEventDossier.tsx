...
export function TitleEventDossier({ title, details, requirement = titleDossierRequirement(title.slug) }: { title: TitleDossier; details?: TitleDetails; requirement?: SpoilerRequirement }) {
  return <section className="title-dossier profile-section">
    ...
    <div className="title-dossier-event" data-reveal><ProgressSpoilerGate requirement={requirement}><SpoilerDisclosure label="RESUMEN CON SPOILERS"><p>{title.event}</p></SpoilerDisclosure></ProgressSpoilerGate></div>
