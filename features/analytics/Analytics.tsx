...
export function Analytics() {
  ...
  useEffect(() => {
    initializeConsentMode();
    const openSettings = () => {
      setAnalyticsEnabled(readAnalyticsConsent() === "accepted");
  ...
  const choose = useCallback((accepted: boolean) => {
    ...
    if (!accepted) {
      window.__nexusAnalyticsReady = false;
      setReady(false);
    }
  ...
  return (
    <>
      ...
      {showBanner && (
        ...
        >
          <div>
            <strong id="consent-title">TU PRIVACIDAD EN NEXUS</strong>
            <p id="consent-description">
              Usamos almacenamiento necesario para tus preferencias. Con tu permiso, Google
              Analytics nos ayuda a entender el uso de la guía sin recibir nombres, correos ni
              tokens.
            </p>
      ...
      {preferencesOpen && (
        <div
          ...
          role="presentation"
          onMouseDown={(event) => {
            if (event.target === event.currentTarget && consent !== null) setPreferencesOpen(false);
          }}
        >
          <section
          ...
          >
            ...
            <h2 id="consent-settings-title">CONFIGURAR COOKIES</h2>
            <div className="consent-choice">
              <div>
                <strong>ALMACENAMIENTO NECESARIO</strong>
                <p>
                  Conserva tus decisiones y progreso local. No puede desactivarse desde este panel.
                </p>
              </div>
            ...
            <label className="consent-choice">
              <div>
                ...
                <p>Permite medir páginas e interacciones mediante Google Analytics 4.</p>
              </div>
              <input
                type="checkbox"
            ...
            <p className="consent-review">
              El texto informativo debe revisarse conforme a las obligaciones legales aplicables al
            ...
            <div className="consent-actions">
              ...
              <button
                ...
                onClick={() => choose(analyticsEnabled)}
              >
