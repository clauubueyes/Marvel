...
export function SpoilerNotice({ requirement }: { requirement?: SpoilerRequirement }) {
  ...
  return (
    <div className="spoiler-notice" role="status" aria-live="polite">
      <p>Tu recorrido continúa</p>
      <p>
        {hint
          ? `Ya has visto ${hint.watched} de ${hint.required} títulos de esta parte. La historia se ampliará con tu progreso.`
          : "Explora el catálogo y marca lo que has visto para seguir descubriendo el UCM."}
      </p>
