...
export const fallbackNews: NewsItem[] = [
  {
    id: "fallback-1",
    title: "Explora las últimas historias del universo Marvel",
  ...
  {
    id: "fallback-2",
    title: "Personajes, cómics y mundos que siguen creciendo",
  ...
  {
    id: "fallback-3",
    title: "Descubre las novedades de Marvel Studios",
