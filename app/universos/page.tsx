...
export const metadata: Metadata = { title: "Universos del MCU — NEXUS", description: "Realidades, continuidades y mundos que forman el multiverso audiovisual de Marvel." };
