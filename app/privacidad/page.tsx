...
export default function PrivacyPage() {
  return <main className="legal-page" style={{ "--accent": "#b9d737", "--accent-2": "#4f6b28" } as React.CSSProperties}>
    ...
    <article>
      ...
      <section><h2>8. Analítica y consentimiento</h2><p>NEXUS utiliza Google Analytics 4 únicamente cuando aceptas el almacenamiento analítico. La medición permite conocer páginas visitadas, sesiones, dispositivo, país de procedencia, fuente de acceso e interacciones editoriales. No configuramos Analytics para enviar nombres, correos, identificadores personales, tokens ni parámetros de consulta de las URL.</p><p>La decisión se conserva en el almacenamiento local del navegador. Google puede tratar datos técnicos conforme a sus propias condiciones y políticas. Rechazar Analytics no impide utilizar la guía.</p><CookieSettingsButton /></section>
      <section><h2>9. Seguridad y cambios</h2><p>Se aplican medidas razonables para limitar el acceso a lo estrictamente necesario. Esta política se actualizará si cambia el modo en que la aplicación utiliza datos. La fecha de revisión aparecerá al comienzo de la página.</p><p><strong>Nota:</strong> la información relativa a Analytics y cookies debe ser revisada por el responsable del sitio para adaptarla a sus obligaciones legales concretas.</p></section>
