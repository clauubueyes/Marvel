...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> { const entity = getMCUEntity("EQUIPO", (await params).slug); return entity ? { title: `${entity.name} — NEXUS`, description: entity.summary } : {}; }
