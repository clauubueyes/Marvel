...
export const metadata: Metadata = { title: "Acontecimientos del MCU — NEXUS", description: "Los sucesos que transformaron y conectaron la historia del universo audiovisual Marvel.", alternates: { canonical: "/eventos" } };
