...
for (const [path, selector] of [
  ["/titulos", ".title-watch-toggle"],
  ["/rutas/camino-a-doomsday", ".route-check"],
]) {
  test(`progress audio at ${path} is lazy, unique, distinct and respects the persisted preference`, async ({
    page,
  }) => {
